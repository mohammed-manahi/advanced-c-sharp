...
public class UserRegistrationView : IView
{
    ...
    public void RunView()
    {
        ...
        _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.Password] = GetInputFromUser(
        ...
        _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.AddressFirstLine] = GetInputFromUser(
            FieldConstants.UserRegistrationField.AddressFirstLine, "Please enter the first line of your address: ");
        _fieldValidator.FieldArray[(int)FieldConstants.UserRegistrationField.AddressSecondLine] = GetInputFromUser(
    ...
    {
        if (!_fieldValidator.FieldValidatorProp((int)field, fieldValue, _fieldValidator.FieldArray,
